...
By accessing the program, you agree to be legally bound by this agreement. If you do not agree to the terms of service and conditions of use stated herein, please immediately leave this site.
          ...
          <View style={[styles.SectionContainer, { marginTop: 10 }]}>
            <View style={styles.SectionTitleContainer}>
              <Text style={styles.SectionTwoTitleTextStyle}>Copyright And Ownership</Text>
            </View>
            <View style={styles.SectionDescriptionContainer}>
              <Text style={styles.SectionDescriptionTextStyle}>
              All of the content featured, displayed or offered for sale on the program, including, but not limited to, text, graphics, photographs, images, moving images, sound, illustrations, software and any other content (collectively, the “Content”), is owned by Increment Technologies, its licensors, vendors and/or its content providers. The program, including but not limited to the design, structure, selection, coordination, expression, "look and feel" and arrangement of such Content, contained on the program is owned, controlled or licensed by Increment Technologies, and is protected by trade dress, copyright, patent and trademark laws, and various other intellectual property rights and unfair competition laws.{"\n\n"}
...
You may not modify any of the materials and you may not copy, distribute, transmit, display, perform, reproduce, publish, license, create derivative works from, transfer or sell any information or work contained on the program. Except as permitted under applicable copyright laws, you are responsible for obtaining permission before reusing any copyrighted material that is available on the program. For purposes of these terms, the use of any such material on any other website or networked computer environment is prohibited.{"\n\n"}
You shall comply with all applicable domestic and international laws, statutes, ordinances and regulations regarding your use of the program. The program, the content and all related rights shall remain the exclusive property of Increment Technologies and its licensors unless otherwise expressly agreed in writing. You will not remove any copyright, trademark or other proprietary notices from material found on the program.
              </Text>
            </View>
          </View>
          ...
          <View style={[styles.SectionContainer, { marginTop: 10 }]}>
            <View style={styles.SectionTitleContainer}>
              <Text style={styles.SectionTwoTitleTextStyle}>User Conduct</Text>
            </View>
            <View style={styles.SectionDescriptionContainer}>
              <Text style={styles.SectionDescriptionTextStyle}>
...
You acknowledge and agree that we may preserve user content and may also disclose user content if required to do so by law, or in the good faith belief that such preservation or disclosure is reasonably necessary to: (a) comply with legal process; (b) enforce the terms; (c) respond to claims that any user content violates the rights of third parties; or (d) protect the rights, property, or personal safety of us, our users and the general public.
          ...
          <View style={[styles.SectionContainer, { marginTop: 10 }]}>
            <View style={styles.SectionTitleContainer}>
              <Text style={styles.SectionTwoTitleTextStyle}>Inappropriate Use</Text>
            </View>
            <View style={styles.SectionDescriptionContainer}>
            <Text style={styles.SectionDescriptionTextStyle}>
            You will not upload, display or otherwise provided on or through the Program any content that: (1) is libelous, defamatory, abusive, threatening, harassing, hateful, offensive or otherwise violates any law or infringes upon the rights of any third party (including copyright, trademark, privacy, publicity or other personal or proprietary rights); or (2) in Increment Technologies judgment, is objectionable or which restricts or inhibits any other person from using the Program or which may expose Increment Technologies or its users to any harm or liability of any kind.
            </Text>
            </View>
          </View>
          ...
          <View style={[styles.SectionContainer, { marginTop: 10 }]}>
            <View style={styles.SectionTitleContainer}>
              <Text style={styles.SectionTwoTitleTextStyle}>Service Charges</Text>
            </View>
            <View style={styles.SectionDescriptionContainer}>
            <Text style={styles.SectionDescriptionTextStyle}>
            Increment Technologies will charge per transaction of up to 20% from the total charges from your peers. We are not in control of the charges submitted by our partners as it will be based on the distance and convenience to send the funds to your receiver. All investors are not allowed or don’t have access to view the charges being submitted by other investors as well so only the user who created the request can view of all the
            </Text>
            </View>
          </View>
          ...
          <View style={[styles.SectionContainer, { marginTop: 10 }]}>
            <View style={styles.SectionTitleContainer}>
              <Text style={styles.SectionTwoTitleTextStyle}>Deleting Your Account</Text>
            </View>
            <View style={styles.SectionDescriptionContainer}>
            <Text style={styles.SectionDescriptionTextStyle}>
            You can delete your account and terminate your use of the Services at any time by sending an email at support@payhiram.ph. Once you have deleted your Account, your access will be revoked and you will no longer have access to your Profile. Please be aware that due to technical reasons beyond our control, it might take some time until your personal information disappears completely from search engines (such as Google). We accept no liability for deletion of information or content from your Profile. You acknowledge and accept that certain User Content may remain after the cancellation of your Profile and that the User Content License shall not be revoked or terminated.
            </Text>
            </View>
          </View>
          ...
          <View style={[styles.SectionContainer, { marginTop: 10 }]}>
            <View style={styles.SectionTitleContainer}>
              <Text style={styles.SectionTwoTitleTextStyle}>Termination Of Your Account By Us</Text>
            </View>
            <View style={styles.SectionDescriptionContainer}>
            <Text style={styles.SectionDescriptionTextStyle}>
            We reserve the right to modify, temporarily suspend or permanently delete your Account and terminate your access to the Services if we have reason to believe that you have breached or acted inconsistently with the Terms. Following termination, your access will be automatically revoked and we reserve the right to delete your Account, erase all or any information on your Profile and discard any of your User Content. You agree that we shall not be liable to you for any modification or discontinuance of the Service.
            </Text>
            </View>
          </View>
        </View>
